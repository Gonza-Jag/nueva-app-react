...
const GuitarCards = ({guitarD}) => {
  ...
  return (
    <div style={{ border:' inset #B8523C 3px', margin:'20px', padding:'20px', height:'500px', width:'420px', display:'flex', flexWrap:'wrap'}}>
        ...
        <button onClick={ () => añadirAlCarrito(guitarD.id )} className="text-green-500 font-bold uppercase px-3 py-1 text-xs outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">Añadir al carrito</button>
